...
<head>
    <meta charset="UTF-8">
    <title>S.I.G.A. - Sistema Integral de Gestión Académica</title>
...
<div id="wrapper">
    ...
    <nav id="myNavmenu" class="navmenu navmenu-default navmenu-fixed-left offcanvas-sm" role="navigation">
        <div class="list-group panel">
            <p class=" list-group-item" title=""><img src="/images/logo.png" alt=""></p>
            ...
            @if(Entrust::hasRole('administrator'))
                <a href="#settings" class=" list-group-item" data-toggle="collapse" data-parent="#MainMenu"><i
                            class="glyphicon glyphicon-cog"></i> {{ __('Configuraciones') }}</a>
                <div class="collapse" id="settings">
                    <a href="{{ route('materias.index')}}"
                       class="list-group-item childlist">{{ __('Materias') }}</a>

                    <a href="{{ route('estados_alumnos.index')}}"
                       class="list-group-item childlist">{{ __('Estados Alumnos') }}</a>
