...
Route::get('/materias/grid', 'MateriasController@grid');
Route::resource('/materias', 'MateriasController');
Route::get('/estados_alumnos/grid', 'Estados_alumnosController@grid');
Route::resource('/estados_alumnos', 'Estados_alumnosController');